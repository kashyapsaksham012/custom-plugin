...
I focus on developing custom solutions for WordPress websites. Part of this development strategy includes establishing a strong online presence. In comes WordPress. While working with and managing multiple WordPress sites, I have used several great themes and plugins that allow me to quickly and easily roll out amazing sites. However, I've come to realize that themes and plugins are not one size fit all. I often run into complications when needing to start adding new functionality or modifying the way existing features work. Sometimes a minor tweak to a plugin template file will be enough, but sometimes I need access and to modify 3rd party data. The easiest way to accomplish this is to incorporate 3rd party data into a new custom plugin.

## 6 Concepts I Learned About When Creating a WordPress Plugin
I had a case where I needed to access 3rd party data that was not offered within a current plugin and display it in a certain format. Since this was my first time rolling out a custom plugin for WordPress, there were a lot of concepts I had to figure out. I am hoping through my experience I can help other developers find their way to writing their first WordPress plugin. Here is an outline of key areas I had to figure out for my plugin. Note: you will be able to find a complete example plugin [here](https://github.com/saksham/wordpress-custom-plugin).
...
I have put all the example code from this article in a public GitHub repo. This is a full functioning custom WordPress Plugin. I welcome any comments or changes. [https://github.com/saksham/wordpress-custom-plugin](https://github.com/saksham/wordpress-custom-plugin)